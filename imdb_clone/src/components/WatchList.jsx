...
function WatchList({watchlist, setWatchList, handleRemoveFromWatchList}) {
  ...
  return (
    ...
    <div className='flex justify-center flex-wrap m-4'>
      {genreList.map((genre)=>{
        return <div onClick={()=>handleFilter(genre)} className={currGenre==genre?'h-[3rem] w-[9rem] rounded-xl flex items-center justify-center bg-blue-400 text-white font-bold mx-4':'h-[3rem] w-[9rem] rounded-xl flex items-center justify-center bg-gray-400/50 text-white font-bold mx-4'}>{genre}</div>
